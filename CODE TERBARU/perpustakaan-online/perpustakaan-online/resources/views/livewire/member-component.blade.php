...
<div class="card">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>{{$data->email}}</td>
      <td>
          <a href="#" wire:c;ick="edit({{$data->id}})" class="btn btn-sm btn-info" data-toggle="modal" data-target="#deletePage">Ubah</a>
          <a href="#" wire:click="confirm({{$data->id}})" class="btn btn-sm btn-danger">Hapus</a>
      </td>
    </tr>
    @endforeach
